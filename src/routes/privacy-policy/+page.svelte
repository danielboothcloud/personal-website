...
<svelte:head>
	<title>Daniel Booth - Privacy policy</title>
</svelte:head>
		...
		<ul>
			...
			<li>
				<p>
					...
					or &quot;Our&quot; in this Agreement) refers to Daniel Booth.
				</p>
			</li>
			<li>
				<p>
			...
			<li>
				<p>
					<strong>Website</strong> refers to Daniel Booth, accessible from
					<a href="danielbooth.xyz" rel="external nofollow noopener" target="_blank">danielbooth.xyz</a>
				</p>
			</li>
			<li>
				<p>
